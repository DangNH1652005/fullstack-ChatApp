...
import { THEMES } from '../../constants/listTheme';
  ...
  return (
    <div className='h-screen container mx-auto px-4 pt-20 max-w-5xl'>
      <div className='space-y-6'>
        ...
        <div className='border rounded-xl border-base-300 overflow-hidden bg-base-100 shadow-lg'> 
              ...
              <div className='bg-base-100 rounded-xl shadow-sm overflow-hidden'>
                ...
                <div className='p-4 border-t border-base-300 bg-base-300'>
                  <div className='flex gap-2'>
                    <input type="text" className='input input-border flex-1 text-sm h-10'
